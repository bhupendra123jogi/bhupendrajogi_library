...
export function Card({ image, link, name, tags }: CardProps) {
  return (
    <div key={name} className="card w-96 bg-base-100 shadow-xl hover:shadow-[#1e2a46] hover:-translate-y-5 transition-all duration-200">
      ...
      <div className="card-body">
        ...
        <div className="btn-group mt-5 w-[174px]">
          <a className="btn hover:btn-active w-11/12" download target='_blank' href={link}>Download</a>
