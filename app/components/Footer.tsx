      ...
      <footer className="footer p-10 bg-base-200 text-base-content">
        <div>
          ...
          <p>
            Cider Inc.
            <br />
            Helping/Making Projects since 2016
            <br />
            <br />
            © 2023 <a className="link link-hover" href="https://www.ciderboi.xyz">Cider Inc.</a> All rights
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <a className="link link-hover" href='https://www.ciderboi.xyz'>Cider boi (Nitya Naman)</a>
        </div>
        <div>
          ...
          <a className="link link-hover" href="mailto:me@ciderboi.xyz">Email (Cider Boi)</a>
          <a className="link link-hover" href="mailto:techformersdps@gmail.com">Email (Techformers Club)</a>
